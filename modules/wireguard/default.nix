    ...
    networking = mkMerge [
      {
        ...
        extraHosts = builtins.concatStringsSep "\n" (
          attrsets.mapAttrsToList (hostName: values: "${values.ip} ${hostName}") cfg.hosts
        );
        ...
        wireguard = {
          ...
          interfaces.wg0 =
            ...
            in
            {
              ips = if cfg.hosts ? hostname then [ "${cfg.hosts."${hostName}".ip}/24" ] else [ ];
              listenPort = 51820;
              ...
              peers =
                ...
                in
                mkIf (!cfg.server) cleanedServerPeers;
            };
        };
      }
